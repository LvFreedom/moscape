...
export default class extends Base {
    ...
    */
	...
	async classifyviewAction(){
		let id = this.get("typeid");
         ...
         .select();
        this.active="admin/classify/index"
        this.assign({
         	info:info,
    ...
    */
  	...
  	async updateclassifyoptionAction(){
     let data = this.post("data");
        data =JSON.parse(data);
     //console.log(data)
        for(let val of data){
